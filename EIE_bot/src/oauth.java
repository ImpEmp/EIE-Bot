...
System.
out.println("Open the following URL and grant access to your account:");
...
System.
out.println("Unable to get the access token.");
...
System.
out.println("Successfully updated the status to [" + status.getText() + "].");
